...
​A full-stack web application designed to streamline the process of capturing and managing potential client leads. This project demonstrates a complete CRUD (Create, Read, Update, Delete) workflow using a modern JavaScript stack.
